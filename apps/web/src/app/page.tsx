  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <header className="sticky top-0 z-20 border-b border-slate-800 bg-slate-950/85 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            ...
            <a href="#use-cases" className="text-sm text-slate-300 hover:text-white">
              Use cases
            </a>
          </nav>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-2 lg:items-center">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-red-500/20 bg-red-500/10 px-3 py-1 text-sm text-red-300">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
            SEAS is a smart emergency alert platform designed to monitor sensor-equipped
            spaces for smoke, gas, flame, and motion activity. It helps users observe
            device status, review alerts, and react faster when something goes wrong.
          </p>
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-2xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-950 p-4">
              <p className="text-sm text-slate-400">Monitored Sites</p>
              <p className="mt-2 text-3xl font-semibold text-white">8</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-950 p-4">
              <p className="text-sm text-slate-400">Status</p>
              <p className="mt-2 text-3xl font-semibold text-emerald-400">Stable</p>
            </div>
          </div>

          <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-950 p-4">
            <p className="text-sm text-slate-400">Recent event</p>
            <div className="mt-3 flex items-center justify-between gap-4">
              <div>
                <p className="font-medium text-white">Smoke detected at Main Warehouse</p>
      ...
      <section id="features" className="mx-auto max-w-7xl px-6 py-16">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-slate-400">
            The system is built around practical environmental and security monitoring.
            It focuses on detecting high-risk signals that matter in homes, offices,
            warehouses, and similar spaces.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {monitoringFeatures.map((feature) => {
            ...
            return (
              ...
              >
                <div className="inline-flex rounded-xl bg-slate-800 p-3 text-red-400">
      ...
      <section id="how-it-works" className="border-y border-slate-800 bg-slate-900/40">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-slate-400">
              SEAS connects hardware monitoring with a software dashboard, turning raw
              sensor readings into visible operational awareness.
            </p>
          </div>
      ...
      <section id="use-cases" className="mx-auto max-w-7xl px-6 py-16">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-slate-400">
            SEAS is meant for people and organizations that want better visibility into
            physical safety risks and abnormal events.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16">
        <div className="rounded-3xl border border-slate-800 bg-slate-900 p-8">
          ...
          <p className="mt-3 max-w-2xl text-slate-400">
            Explore the system dashboard, register an account, and begin building a
            monitored environment with smart emergency awareness at its core.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <Link
              href="/login"
              className="rounded-xl border border-slate-700 px-5 py-3 text-sm font-medium text-slate-200 transition hover:border-slate-500 hover:bg-slate-950"
            >
              Sign in
            </Link>
          </div>
